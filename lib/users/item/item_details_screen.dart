...
import 'package:final_flutter_project/users/cart/cart_list_screen.dart';
import 'package:final_flutter_project/users/controllers/item_details_controller.dart';
  ...
  addItemToFavoriteList() async
  {
    try
    {
      ...
      if(res.statusCode == 200) //from flutter app the connection with api to server - success
      {
        ...
        {
          Fluttertoast.showToast(msg: "Item added to favourite list.");

          validateFavoriteList();
        }
        else
        {
          Fluttertoast.showToast(msg: "Item did not added to favourite list.");
        }
      }
      else
      {
