import 'package:final_flutter_project/users/controllers/order_now_controller.dart';
import 'package:final_flutter_project/users/order/order_confirmation.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Any instructions you want to add',
                hintStyle: const TextStyle(
                  color: Colors.white24,
                ),
                border: OutlineInputBorder(
