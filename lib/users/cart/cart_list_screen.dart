...
import 'package:final_flutter_project/users/controllers/cart_list_controller.dart';
import 'package:final_flutter_project/users/model/cart.dart';
import 'package:final_flutter_project/users/model/clothes.dart';
import 'package:final_flutter_project/users/order/order_now_screen.dart';
import 'package:final_flutter_project/users/userPreferences/current_user.dart';
  ...
  getCurrentUserCartList() async
  {
    ...
    try
    {
      ...
      if (res.statusCode == 200)
      {
        ...
        {
          for (var eachCurrentUserCartItemData in (responseBodyOfGetCurrentUserCartItems['currentUserCartData'] as List)) {
                  ...
                  onPressed: () async
                  {
                    var responseFromDialogBox = await Get.dialog(
                      AlertDialog(
                        ...
                        content: const Text("Are you sure to delete selected items from your cart?"),
                        actions:
                        [
                          TextButton(
                            onPressed: ()
                    ...
                    {
                      for (var selectedItemUserCartID in cartListController.selectedItemList) {
